...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <?php
        ...
        {
            echo "<option value='$rspatient[patientid]' ";
                        echo (isset($rsedit) && ($rspatient['patientid'] == $rsedit['patientid']))?"selected":"";
                        echo ">$rspatient[patientname]</option>";
        ...
        <div class="col-sm-4">
            <select class="form-control" name="department" id="department" placeholder="Enter lastname...." required="">
                ...
                <?php
                    ...
                    {
                        echo "<option value='$rsdepartment[departmentid]' ";
                        echo (isset($rsedit) && ($rsdepartment['departmentid'] == $rsedit['departmentid']))?"selected":"";
                        echo ">$rsdepartment[departmentname]</option>";
