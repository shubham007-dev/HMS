...
<meta name="author" content="Shubham Pawar">
...
{
  $passw = hash('MD5', $_POST['password']);
  // echo $passw; die;
  function createSalt()
  {
      return '49627764jn519shubhamrAdW';
  }
  // $salt = createSalt();
  // $pass = hash('MD5', $salt . $passw);
    // echo $pass;
    // die;
  if($_POST['user'] == 'admin'){
    $sql = "SELECT * FROM admin WHERE loginid='" .$email . "' and password = '". $passw."'";
